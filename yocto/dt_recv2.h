...
public:
	...
	DataTableRecvVarProxyFn	get_data_tableProxyFn() const;
...
inline bool RecvTable::is_init() const
{
...
#define RecvPropq_angles RecvPropvector
...
inline DataTableRecvVarProxyFn RecvProp::get_data_tableProxyFn() const
{
