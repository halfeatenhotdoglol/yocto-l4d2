...
public:
	...
	inline int c_offsets::get_health(baseentity* pEntity) {return *make_ptr(int, pEntity, offset_DT_BasePlayer__m_iHealth);}
	inline bool c_offsets::is_alive(baseentity* pBaseEntity){return handle_structs::life_states::LIFE_ALIVE == *make_ptr(BYTE, pBaseEntity, offset_DT_BasePlayer__m_lifeState);}
	inline int c_offsets::get_flags(baseentity* pBaseEntity){return *make_ptr(int, pBaseEntity, offset_DT_BasePlayer__m_fFlags);}
	inline int c_offsets::get_sequence(baseentity* ent) { return *make_ptr(int, ent, offset_DT_BaseAnimating__m_nSequence); }
	inline const HANDLE c_offsets::get_active_weapon(baseentity* ent) { return *make_ptr(HANDLE, ent, offset_DT_BaseCombatCharacter__m_hActiveWeapon); }
	inline vector c_offsets::get_infected_origin(baseentity* ent) { return *make_ptr(vector, ent, offset_DT_Infected__m_vecOrigin); }
	inline vector c_offsets::get_entity_origin(baseentity* ent) { return *make_ptr(vector, ent, offset_DT_BaseEntity__m_vecOrigin); }
	inline bool c_offsets::get_witch_state(baseentity* ent) { return *make_ptr(bool, ent, offset_DT_Witch__m_wanderRage);}
	inline int c_offsets::get_team_num(baseentity* ent) { return *make_ptr(int, ent, offset_DT_BaseEntity__m_iTeamNum); }
};
//===================================================================================
