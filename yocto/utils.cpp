...
inline void vec_trans(const vector in1, float in2[3][4], vector& out){out[0] = dot(in1, vector(in2[0][0], in2[0][1], in2[0][2])) + in2[0][3];out[1] = dot(in1, vector(in2[1][0], in2[1][1], in2[1][2])) + in2[1][3];out[2] = dot(in1, vector(in2[2][0], in2[2][1], in2[2][2])) + in2[2][3];}
