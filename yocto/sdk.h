...
typedef struct cscreensize_t{ int screen_height, screen_width; } cscreensize; extern cscreensize screen_size;
inline void**& get_vtable(void* inst, size_t offset = 0) { return *reinterpret_cast<void***>((size_t)inst + offset); }
inline const void** get_vtable(const void* inst, size_t offset = 0) { return *reinterpret_cast<const void***>((size_t)inst + offset); }
template< typename Fn >
inline Fn get_vfunc(const void* inst, size_t index, size_t offset = 0) { return reinterpret_cast<Fn>(get_vtable(inst, offset)[index]); }
//================================================================================================
namespace handle_structs
{
	...
	struct mstudiohitboxset_t
	{
		...
		int	numhitboxes;
		int	hitboxindex;
		inline mstudiobbox_t* get_hitbox(int i) const { return (mstudiobbox_t*)(((BYTE*)this) + hitboxindex) + i; };
	};
	struct mstudiobone_t
	{
		...
		inline void* get_procedure() const { if (procindex == 0) return NULL; else return  (void*)(((BYTE*)this) + procindex); };
		int	surfacepropidx; // index into string tablefor property name
		inline char* const get_surface_props(void) const { return ((char*)this) + surfacepropidx; }
...
namespace ssdk {
	...
	public:
		...
		inline bool setup_bones(matrix3x4* pBoneToWorldOut, int nMaxBones, int boneMask, float currentTime)
		{
			__asm
			{
				MOV EDI, this
		...
		//========================= ================= =================== =============
		const handle_structs::class_groups::groups get_entity_group(ssdk::c_base_entity* ent);
	...
	{
	public:
		inline void set_mat_var_flag(handle_structs::mat::mat_var_flags flag, bool on)
		{
			return get_vfunc<void(__thiscall*)(material*, handle_structs::mat::mat_var_flags, bool)>(this, 29)(this, flag, on);
		}
	...
	{
	public:
		material* find_mat(char const* pMaterialName, const char* pTextureGroupName, bool complain = true, const char* pComplainPrefix = 0)
		{
			return get_vfunc<material* (__thiscall*)(material_system*, const char*, const char*, bool, const char*)>(this, 71)(this, pMaterialName, pTextureGroupName, complain, pComplainPrefix);
		}
	};
	//=======================================================================
	...
	{
	public:
		inline void forced_mat_override(material* newMaterial, int nOverrideType = 0)
		{
			return get_vfunc<void(__thiscall*)(model_renderer*, material*, int)>(this, 1)(this, newMaterial, nOverrideType);
		}
	};
	//=======================================================================
	...
	public:
		...
		void setup_move(c_base_entity* player, handle_structs::player_related::user_cmd* cmd, i_move_helper* helper, handle_structs::move_data* move)
		{
			typedef void(__thiscall* o)(PVOID, c_base_entity*, handle_structs::player_related::user_cmd*, i_move_helper*, handle_structs::move_data*);
			get_vfunc<o>(this, 19)(this, player, cmd, helper, move);
		}
		void finish_move(c_base_entity* player, handle_structs::player_related::user_cmd* cmd, handle_structs::move_data* move)
		{
			typedef void(__thiscall* o)(PVOID, c_base_entity*, handle_structs::player_related::user_cmd*, handle_structs::move_data*);
	...
	public:
		...
		void set_font(unsigned long& font, const char* windowsFontName, int tall, int weight, int blur, int scanlines, int flags)
		{
